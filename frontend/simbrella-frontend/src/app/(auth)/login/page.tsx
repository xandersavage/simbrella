    ...
    <div className="h-screen relative overflow-hidden flex items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        <div className="relative group">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-1000 animate-tilt"></div>{" "}
          {/* Main form container */}
